        ...
        <ScrollView  horizontal={true} pagingEnabled={true}>
         ...
         <View style={{
                ...
                <View style = {styles.example}>
                    ...
                    <Text　style = {{fontSize: 8,textAlign:'right',position: 'relative', top:33, right:10}}> 感染症プラチナマニュアル2018,  MEDSi</Text>
                    <Text　style = {{fontSize: 8,textAlign:'right',position: 'relative', top:33, right:10}}> レジデントのための感染症マニュアル第3版,  医学書院</Text>  
                </View>
            </View>
         ...
         <View style={{
           ...
           <Text　style ={styles.esc}> 腎盂腎炎 </Text> 
            ...
            <View style = {styles.guidline}>
                ...
                <Text style ={{  paddingTop: 1, fontSize: 12}}>ロセフィン 2g 外来で投与後に{"\n"}オーグメンチン 375mg + サワシリン 250mg  1日3回  14日間</Text>
