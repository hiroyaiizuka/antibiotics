...
class BackgroundScreen extends React.Component{
  ...
  componentDidMount(){
    this.props.navigation.setParams({handleCcr: ()=> this.props.navigation.navigate('SevereN')})
}
        ...
        return(
          <View style = {styles.container}>　
            ...
            <View style = {styles.assess}>
              ...
              <Text style={{paddingTop:12, color: '#fff'}}>亜急性期型終末期:</Text>
              <Text style={{paddingTop:3, paddingBottom: 8, color: '#fff', fontSize:12}}>病状が進行して、生命予後が半年以内と考えられる時期</Text>
              <Text style={{paddingTop:8, color: '#fff'}}>慢性型終末期:</Text>
